...
List<Product> products = [
  ...
  Product(
    ...
    review: 'Very comfortable, perfect for long runs!',
    seller: 'Sportify',
    price: 79.99,
  ...
  Product(
    ...
    review: 'Stylish and packed with features.',
    seller: 'TechWear',
    price: 149.99,
  ...
  Product(
    ...
    review: 'Elegant design and very spacious.',
    seller: 'Urban Bags',
    price: 120.00,
  ...
  Product(
    ...
    review: 'Lightweight and looks great!',
    seller: 'SunStyle',
    price: 45.50,
